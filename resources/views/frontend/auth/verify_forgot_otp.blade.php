                ...
                <div class="col-xl-4 col-lg-5 col-md-7 col-12 mx-auto">
                    ...
                    <div class="babi-auth-wrapper">
                        <div class="babi-auth-header mb-4 text-center">
                            {{-- ۱. تغییر عنوان برای بازیابی رمز --}}
                            <h2 class="babi-auth-title">تایید بازیابی رمز عبور</h2>
                        ...
                        <div class="babi-mobile-info-box d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                ...
                                {{-- ۲. تغییر سشن شماره به reset_mobile و لینک ویرایش به فرم درخواست رمز --}}
                                <span class="babi-phone-num" dir="ltr">{{ session('reset_mobile') ?? '---' }}</span>
                            </div>
                            <a href="{{ route('password.request.otp') }}" class="babi-edit-phone-btn">
                                <i class="fal fa-edit ml-1"></i> ویرایش شماره
                            </a>
                        </div>

                        {{-- ۳. تغییر اکشن فرم به روت تایید کد فراموشی رمز --}}
                        <form action="{{ route('password.verify.otp') }}" method="POST" id="otp-form">
                            @csrf

                            <div class="form-row justify-content-center mb-4">
                                <div class="babi-otp-container" dir="ltr">
                                    <input name="code[]" type="tel" maxlength="1" class="babi-otp-input" inputmode="numeric" pattern="[0-9]*" autocomplete="off" autofocus required>
                                    <input name="code[]" type="tel" maxlength="1" class="babi-otp-input" inputmode="numeric" pattern="[0-9]*" autocomplete="off" required>
                                    <input name="code[]" type="tel" maxlength="1" class="babi-otp-input" inputmode="numeric" pattern="[0-9]*" autocomplete="off" required>
                                    <input name="code[]" type="tel" maxlength="1" class="babi-otp-input" inputmode="numeric" pattern="[0-9]*" autocomplete="off" required>
                                    <input name="code[]" type="tel" maxlength="1" class="babi-otp-input" inputmode="numeric" pattern="[0-9]*" autocomplete="off" required>
                                </div>
                            ...
                            <div class="form-row justify-content-center mb-4">
                                <div class="babi-timer-wrapper text-center">
                                    <div id="babi-countdown-container" class="d-flex align-items-center justify-content-center">
                                        ...
                                        <span id="countdown-verify-end" class="font-weight-bold text-danger mr-1">02:00</span>
                                    </div>
                        ...
                        <div class="babi-auth-footer mt-4 text-center">
                            <a href="{{ route('login') }}" class="babi-redirect-link mr-1">بازگشت به صفحه ورود</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            resendBtn.addEventListener('click', function () {
                ...
                {{-- ۴. تغییر آدرس درخواست AJAX ارسال مجدد کد --}}
