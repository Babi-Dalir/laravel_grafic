    ...
    <table class="table table-striped table-hover">
        ...
        @forelse($property_groups as $index=>$property_group)
            <tr>
                ...
                <td class="text-center align-middle">
                    <a class="btn btn-outline-danger" wire:click="$dispatch('deletePropertyGroup',{'id':{{$property_group->id}}})">
                        حذف
                    </a>
                </td>
                    ...
                    <td colspan="9" class="text-center py-5" style="background-color: #f9f9f966;">
                        <div class="empty-state">
                            ...
                            <svg width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="#d1d5db" stroke-width="1.5"
                                ...
                                <p class="text-muted">گروه ویژگی با عبارت <strong class="text-danger">"{{ $search }}"</strong>
