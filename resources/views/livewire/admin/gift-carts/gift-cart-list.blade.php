        ...
        @forelse($gift_carts as $index=>$gift_cart)
            <tr>
                ...
                <td class="text-center align-middle">
                    <div class="status-interactive-wrapper" wire:click="changeStatus({{$gift_cart->id}})">
                        ...
                        @elseif($gift_cart->status === \App\Enums\GiftCartStatus::InActive->value)
                    ...
                    <td colspan="9" class="text-center py-5" style="background-color: #f9f9f966;">
                        <div class="empty-state">
                            ...
                            <svg width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="#d1d5db" stroke-width="1.5"
                                ...
                                <p class="text-muted">کارت هدیه ای با عبارت <strong class="text-danger">"{{ $search }}"</strong>
