<div class="table overflow-auto" tabindex="8">
    ...
    <div class="form-group row">
        <label class="col-sm-3 col-form-label font-weight-bold">جستجو (نام، کد ملی، برند، کد سفارش)</label>
    ...
    <table class="table table-striped table-hover align-middle">
        ...
        <tr>
            ...
            <th class="text-center">مبلغ تراکنش (تومان)</th> {{-- 🟢 اصلاح واحد پولی --}}
        ...
        @forelse($transactions as $tx)
            <tr wire:key="transaction-row-{{ $tx->id }}">
                ...
                <td class="text-center">
                    @if($tx->type === \App\Enums\TransactionType::Sale->value || $tx->type === \App\Enums\TransactionType::Sale)
                ...
                <td class="text-center">
                    {{-- 🟢 اصلاح گارد انوم برای وضعیت زنده دیتابیس --}}
