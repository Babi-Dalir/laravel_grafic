    ...
    <table class="table table-striped table-hover">
        ...
        @foreach($colors as $index=>$color)
            <tr>
                ...
                <td class="text-center align-middle">
                    <a class="btn btn-outline-danger" wire:click="$dispatch('deleteColor',{'id':{{$color->id}}})">
                        حذف
                    </a>
                </td>
                <td class="text-center align-middle">{{\Hekmatinasser\Verta\Verta::instance($color->created_at)->format('%d%B، %Y')}}</td>
            </tr>
        @endforeach
    </table>
        ...
        Livewire.on('deleteColor', (event) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.dispatch('destroy_color',{id : event.id})
                    Swal.fire({
