            ...
            <tr>
                ...
                <td class="text-center align-middle">
                    <figure class="avatar avatar">
                        <img src="{{url('images/brands/small/'.$brand->image)}}" class="rounded-circle" alt="image">
                    </figure>
                </td>
                ...
                <td class="text-center align-middle">
                    <a class="btn btn-outline-danger" wire:click="$dispatch('deleteBrand',{'id':{{$brand->id}}})">
                        حذف
                    </a>
                </td>
                <td class="text-center align-middle">{{\Hekmatinasser\Verta\Verta::instance($brand->created_at)->format('%d%B، %Y')}}</td>
            </tr>
        @endforeach
    </table>
