            ...
            <div class="col-md-9 col-sm-12 comment-content">
                ...
                <div class="footer">
                    <div class="comments-likes">
                        ...
                        <button wire:click="like({{$comment->id}})" class="btn-like" data-counter="{{$comment->like}}">بله
                        </button>
                        <button wire:click="dislike({{$comment->id}})" class="btn-like" data-counter="{{$comment->dislike}}">خیر
                        </button>
                    </div>
                </div>
            </div>
