<div class="modal fade" id="modal-location" role="dialog" wire:ignore.self aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
                            ...
                            <form class="form-account" wire:submit.prevent="submit">
                                <div class="row">
                                    <div class="col-md-6 col-sm-12 mb-2">
                                        ...
                                        <div class="form-row">
                                            <input class="input-ui pr-2 text-right" wire:model="name" type="text"
                                    ...
                                    <div class="col-md-6 col-sm-12 mb-2">
                                        ...
                                        <div class="form-row">
                                            <input class="input-ui pl-2 dir-ltr text-left" wire:model="mobile"
                                    ...
                                    <div class="col-12 mb-2">
                                        ...
                                        <div class="form-row">
                                            <textarea wire:model="address" class="input-ui pr-2 text-right" placeholder=" آدرس تحویل گیرنده را وارد نمایید"></textarea>
                                            @error('address')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
