            ...
            <div class="card-body">
                <div class="container">
                    ...
                    <form method="POST" action="{{route('categories.update',$category->id)}}" enctype="multipart/form-data">
                        ...
                        @method('put')
                        <div class="row mb-4">
                            <img class="offset-6" style="height: 200px;width: 200px" src="{{url('images/categories/big/'.$category->image)}}" alt="">
                        </div>
                        <div class="form-group row">
                            <label  class="col-sm-2 col-form-label">نام دسته بندی</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control text-left" dir="rtl" name="name" value="{{$category->name}}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control text-left" dir="rtl" name="e_name" value="{{$category->e_name}}">
                            </div>
                        </div>
                        <div class="form-group row">
