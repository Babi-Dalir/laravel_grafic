            ...
            <div class="card-body">
                <div class="container">
                    ...
                    <form method="POST" action="{{route('sliders.update',$slider->id)}}" enctype="multipart/form-data">
                        ...
                        @method('put')
                        <div class="row mb-4">
                            <img class="offset-6" style="height: 200px;width: 200px" src="{{url('images/sliders/big/'.$slider->image)}}" alt="">
                        </div>
                        <div class="form-group row">
                            <label  class="col-sm-2 col-form-label">لینک</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control text-left" dir="rtl" name="link" value="{{$slider->link}}">
                            </div>
                        </div>
                        <div class="form-group row">
