        ...
        <div class="card">
            <div class="card-body">
                <div class="container">
                    ...
                    <form class="dropzone border border-primary" id="productGalleryDropzone" method="post" action="{{route('store.product.gallery',$product->id)}}" enctype="multipart/form-data">
                        @csrf
...
@section('scripts')
    <script>
        ...
        $(document).ready(function () {
            var myDropzone = new Dropzone("#productGalleryDropzone", {
                paramName: "file",
                maxFilesize: 2,
                ...
                success: function (file, response) {
                    ...
                    if (window.Livewire) {
                        window.Livewire.dispatch('refreshGalleryList');
                    }
