        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="container">
                    ...
                    <form method="POST" action="{{route('store.role.permission',$role->id)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                              ...
                              <div class="list-group">
                                  ...
                                  @foreach($permissions as $permission)
                                      <div class="form-check d-flex align-items-center">
                                          ...
                                          <lable class="list-group-item list-group-item-action mt-2">{{$permission->name}}</lable>
                                      </div>
                                  @endforeach
                              </div>
                            </div>
