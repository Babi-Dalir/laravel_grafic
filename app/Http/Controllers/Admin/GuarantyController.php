...
class GuarantyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('guaranties.index')->with('message', 'گارانتی جدید با موفقیت ایجاد شد');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.guaranties.edit', compact('guaranty','title'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('guaranties.index')->with('message', 'گارانتی جدید با موفقیت ویرایش شد');
    }
