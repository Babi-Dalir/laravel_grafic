...
class ProvinceController extends Controller
{
    ...
    public function store(ProvinceRequest $request)
    {
        ...
        return redirect()->route('provinces.index')->with('message', 'استان جدید با موفقیت ایجاد شد');
    }
    ...
    public function update(ProvinceRequest $request, string $id)
    {
        ...
        return redirect()->route('provinces.index')->with('message', 'استان جدید با موفقیت ویرایش شد');
    }
